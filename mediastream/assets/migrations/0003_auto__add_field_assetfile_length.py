...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssetFile.length'
        db.add_column('assets_assetfile', 'length', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AssetFile.length'
        db.delete_column('assets_assetfile', 'length')
