...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assets_play', (
            ...
            ('context', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('previous_play', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Play'], null=True, blank=True)),
            ('queue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['queuer.AssetQueue'], null=True, blank=True)),
        ))
        db.send_create_signal('assets', ['Play'])


    def backwards(self, orm):
        
        # Deleting model 'Play'
        db.delete_table('assets_play')
