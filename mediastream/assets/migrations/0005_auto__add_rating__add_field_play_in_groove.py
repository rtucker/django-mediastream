...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assets_rating', (
            ...
            ('play', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Play'], null=True, blank=True)),
            ('rating', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal('assets', ['Rating'])

        # Adding field 'Play.in_groove'
        db.add_column('assets_play', 'in_groove', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Rating'
        db.delete_table('assets_rating')

        # Deleting field 'Play.in_groove'
        db.delete_column('assets_play', 'in_groove')
    ...
    models = {
        ...
        'assets.play': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_groove': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
