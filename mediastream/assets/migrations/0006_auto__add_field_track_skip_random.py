...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.skip_random'
        db.add_column('assets_track', 'skip_random', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Track.skip_random'
        db.delete_column('assets_track', 'skip_random')
