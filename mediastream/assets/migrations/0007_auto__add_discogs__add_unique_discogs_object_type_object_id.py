...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Discogs'
        db.create_table('assets_discogs', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('object_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('data_cache', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('data_cache_dttm', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('assets', ['Discogs'])

        # Adding unique constraint on 'Discogs', fields ['object_type', 'object_id']
        db.create_unique('assets_discogs', ['object_type', 'object_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Discogs', fields ['object_type', 'object_id']
        db.delete_unique('assets_discogs', ['object_type', 'object_id'])

        # Deleting model 'Discogs'
        db.delete_table('assets_discogs')
