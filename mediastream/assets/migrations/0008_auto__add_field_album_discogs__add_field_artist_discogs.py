...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.discogs'
        db.add_column('assets_album', 'discogs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Discogs'], null=True, blank=True), keep_default=False)

        # Adding field 'Artist.discogs'
        db.add_column('assets_artist', 'discogs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assets.Discogs'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Album.discogs'
        db.delete_column('assets_album', 'discogs_id')

        # Deleting field 'Artist.discogs'
        db.delete_column('assets_artist', 'discogs_id')
