...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field extra_artists on 'Album'
        db.create_table('assets_album_extra_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('album', models.ForeignKey(orm['assets.album'], null=False)),
            ('artist', models.ForeignKey(orm['assets.artist'], null=False))
        ))
        db.create_unique('assets_album_extra_artists', ['album_id', 'artist_id'])

        # Adding M2M table for field extra_artists on 'Track'
        db.create_table('assets_track_extra_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('track', models.ForeignKey(orm['assets.track'], null=False)),
            ('artist', models.ForeignKey(orm['assets.artist'], null=False))
        ))
        db.create_unique('assets_track_extra_artists', ['track_id', 'artist_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field extra_artists on 'Album'
        db.delete_table('assets_album_extra_artists')

        # Removing M2M table for field extra_artists on 'Track'
        db.delete_table('assets_track_extra_artists')
    ...
    models = {
        ...
        'assets.discogs': {
            'Meta': {'unique_together': "(('object_type', 'object_id'),)", 'object_name': 'Discogs'},
