...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assets_asset', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_assets', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Asset.shared_with_all'
        db.add_column('assets_asset', 'shared_with_all', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field shared_with on 'Asset'
        db.create_table('assets_asset_shared_with', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('asset', models.ForeignKey(orm['assets.asset'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('assets_asset_shared_with', ['asset_id', 'user_id'])


    def backwards(self, orm):
        
        # Deleting field 'Asset.owner'
        db.delete_column('assets_asset', 'owner_id')

        # Deleting field 'Asset.shared_with_all'
        db.delete_column('assets_asset', 'shared_with_all')

        # Removing M2M table for field shared_with on 'Asset'
        db.delete_table('assets_asset_shared_with')
