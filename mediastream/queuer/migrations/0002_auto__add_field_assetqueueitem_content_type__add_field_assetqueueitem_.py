...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AssetQueueItem.content_type'
        db.delete_column('queuer_assetqueueitem', 'content_type_id')

        # Deleting field 'AssetQueueItem.object_id'
        db.delete_column('queuer_assetqueueitem', 'object_id')
